...
public class GameItem {
    ...
    static {
        ...
        eatableItems = Utils.parseJSON("assets/item/item_event.json", subItemListType);
    }
    ...
    public static GameItem randomFromEvent() {
        ...
        List<StatAffect> statAffects = new ArrayList<>();
        statAffects.addAll(prefix.statAffects);
        statAffects.addAll(root.statAffects);
        statAffects.addAll(suffix.statAffects);
        item.statAffects = StatAffect.solidify(shorten(statAffects));
